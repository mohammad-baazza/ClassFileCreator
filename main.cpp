...
void fill_hpp_file(std::ofstream &file, std::string &name, char *class_name)
{
	...
	file << "# define " << macro_name << std::endl
		 << std::endl;
	file << "class " << class_name << std::endl
		 << '{' << std::endl
		 << "\tpublic :" << std::endl;
...
{
	file << "#include \"" << filename.substr(0, filename.length() - 4) << ".hpp\"" << std::endl
		 << std::endl;
	file << class_name << "::" << class_name << "(void) {}" << std::endl
		 << std::endl;
	...
	file << class_name << "::~" << class_name << "(void) {}" << std::endl
		 << std::endl;
	file << class_name << " const\t&" << class_name << "::operator = (" << class_name << " const &rhs)" << std::endl
		 << "{" << std::endl
...
{
	std::cout << "\tclasses' .cpp and .hpp files creator" << std::endl
			  << std::endl;
	std::cout << "\tusage : " << program_name << " -h | [-sd] class_names ..." << std::endl
			  << std::endl;
